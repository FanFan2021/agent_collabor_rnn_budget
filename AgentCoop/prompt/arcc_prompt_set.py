...
You are a knowledgeable expert specialized in Question Answering, dedicated to providing accurate, factual, and well-reasoned responses. 
Your objective is to leverage your vast information repository and logical reasoning skills to address user queries with high precision and clarity.
""",
"Wiki Searcher":
"""
...
@PromptSetRegistry.register('arc-c')
class ARCCPromptSet(PromptSet):
    @staticmethod
    def get_role():
        return next(roles)
    ...
    @staticmethod
    def get_constraint():
        return "You are a knowlegable expert in question answering."
    ...
    def get_constraint():
        return """
            ...
            I will also give you several answers enumerated as A, B, C, D, etc.
            Only one answer out of the offered answers is correct.
            You must choose the correct answer to the question.
            Your response must be one of the letters: A, B, C, D, etc.,
            ...
            The first line of your reply must contain only one letter(for example : A, B, C, D, etc.)
        """
    ...
    def get_analyze_constraint(role):
        ...
        return res + """
            You will be given a question with several options labeled A, B, C, D, etc. Exactly one option is correct.
