...
We provide the code of our paper. The algorithm implementation code is in `AgentCoop` folder, and the experimental code is in `experiments` folder.
...
```bash
conda create -n AgentCoop python=3.10
conda activate AgentCoop
...
### Run AgentCoop on MMLU by running the following scripts
