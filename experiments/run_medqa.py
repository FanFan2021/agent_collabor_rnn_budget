...
from dataset.medqa_dataset import load_medqa
from experiments.train_medqa import train
from experiments.evaluate_medqa import evaluate
...
def parse_args():
    ...
    parser.add_argument('--domain', type=str, default="medqa",
                        help="Domain (the same as dataset name), default 'MEDQA'")
    ...
    parser.add_argument('--train_file_path', type=str, default="/MedQA/train.jsonl",
                        help="The path to the training file")
    parser.add_argument('--eval_file_path', type=str, default="/MedQA/test.jsonl",
                        help="The path to the evaluation file")
    ...
    parser.add_argument('--limit_train_questions', type=int, default=6400,
                        help="The number of questions to use for training")
    parser.add_argument('--limit_eval_questions', type=int, default=200,
    ...
    # wandb args
    parser.add_argument('--wandb_project', type=str, default="AgentCoop-MEDQA-ADV-Budget",
...
async def main():
    ...
    dataset_val = load_medqa(file_path=args.eval_file_path)
